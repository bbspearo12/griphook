...
class ProjectGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Project entity")
        ...
        .repeat(2) {
            ...
            .post("/api/projects")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "accoutManager":"SAMPLE_TEXT", "presalesArchitect":"SAMPLE_TEXT", "defaultProjectMargin":null, "subcontractProjectMargin":null, "pmpercentage":null, "risk":null}""")).asJSON
            .check(status.is(201))
